...
if produce_data_df:
    ...
    save_pd_to_pickle(data_df, r'E:\Dropbox (UCL - SWC)\big_Arena\analysis\data_df_newnet_nondistflight')
...
if save_out_flight_df:
    save_pd_to_pickle(flight_df, r'E:\Dropbox (UCL - SWC)\big_Arena\analysis\flight_df_newnet_nondistflight')